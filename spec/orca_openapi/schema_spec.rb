...
RSpec.describe OrcaOpenAPI::Schema do
  ...
  # These tests verify the Generator correctly reads field_metadata from Schema-including classes.
  describe 'schema generation via Generator' do
    ...
    it 'generates object schema with properties' do
      schema = generate_schema(SchemaTestFixtures::BasicSchema)
    ...
    it 'overrides format from metadata' do
      schema = generate_schema(SchemaTestFixtures::WithFormats)
    ...
    context 'with nested schemas' do
      it 'uses $ref for nested schema types in arrays' do
        schema = generate_schema(SchemaTestFixtures::WithNestedArray)
    ...
    context 'with empty schema' do
      it 'returns object type with empty properties' do
        schema = generate_schema(SchemaTestFixtures::EmptySchema)
    ...
    context 'with auto-inferred formats' do
      ...
      it 'auto-infers float format for Float fields' do
        schema = generate_schema(SchemaTestFixtures::NestedItem)
